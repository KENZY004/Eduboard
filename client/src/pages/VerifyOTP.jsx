            ...
            >
                <div>
                    ...
                    >
                        ...
                        <Link to="/login" className="text-sm text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white transition-colors font-medium">
                            ← Back to Login
                        </Link>
                    </motion.div>
                    ...
                    <p className="text-slate-600 dark:text-slate-400 text-sm sm:text-base mb-6 sm:mb-8 transition-colors font-medium">
                ...
                <form onSubmit={handleSubmit} className="space-y-6 max-w-sm">
                    <div className="group">
                        <label className="block text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest mb-2 ml-1 transition-colors">Security Code</label>
                    ...
                    >
                        <span className="tracking-widest uppercase text-xs">{isLoading ? 'Verifying...' : 'Authorize Transaction'}</span>
